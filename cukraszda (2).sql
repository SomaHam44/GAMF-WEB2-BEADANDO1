...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Okt 31. 19:08
...
(11, 'Kis', 'Kanal', 'kiskanal', '52a4a4e0f25081ec222908617378fc62612048fd', '_1_'),
(12, 'Nagy', 'Kanál', 'nagykanal', 'b3ab7fa81ae803206c5d38a5fd598112415371f8', '_1_');
...
--
ALTER TABLE `velemenyek`
  ADD CONSTRAINT `velemeny_ibfk_1` FOREIGN KEY (`hirID`) REFERENCES `hirek` (`hirID`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
